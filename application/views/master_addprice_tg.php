                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>masterdata/insert_price_ta" method="post">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Code From</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control codeto" name="statediv">
                                                                <?php 
                                                                    foreach($state  as $r): 
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">To Gate </label>
                                                <div class="col-sm-10">
                                                    <select class="form-control codeto" name="statediv">
                                                                <?php 
                                                                    foreach($state  as $r): 
